...
<?php $GLOBALS["menu"] = 'de-nghi-cap-ac-can-bo,de-nghi-cap-ac'; ?>
<body>
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="header-top">
                    ...
                    <div class="top-left">
                        <div class="breadcrumb">
                            ...
                            <span class="breadcrumb-item active">Đề nghị cấp ấn chỉ cán bộ</span>
                        </div>
                ...
                <div class="page-title">
                    <div class="p-title">
                        <p class="font-weight-semibold font-size-m mb-0"><i class="fad fa-user-tie mr-1"></i>Đề nghị cấp ấn chỉ cán bộ</p>
                    </div>
                    <div class="p-button">
                    </div>
                </div>
                                        ...
                                        <div class="form-box mb-3">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-content col-content-sm">
                                                    <input type="text" class="form-control input-date datepicker " placeholder="dd/mm/yyyy" value="25/11/2020">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-content col-content-md">
                                                    <select select2="" class="form-control">
                                                        ...
                                                        <option>Khác</option>
                                                        <option selected="">Trực tiếp</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-content col-content-xl">
                                                    <textarea class="form-control" placeholder="">Đề xuất cấp ấn chỉ lần đầu cho VNI Phú Thọ</textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <table class="table datatable" data-paging="false" data-info="false" data-ordering="false" data-searching="false">
                                                    ...
                                                    <tbody data-repeater-list="loai_khau_tru">
                                                        <tr data-repeater-item>
                                                            <td>
                                                                <select select2="" class="form-control">
                                                                    ...
                                                                    <option selected="" value="GCNBH_MC" id="GCNBH_MC">Ấn chỉ bảo hiểm xe máy</option>
                                                            ...
                                                            <td>
                                                                <select select2="" class="form-control">
                                                                    ...
                                                                    <option selected="" id="BAT_BUOC_TU_NGUYEN" value="BAT_BUOC_TU_NGUYEN" name="Bắt buộc và tự nguyện">Bắt buộc và tự nguyện</option>
                                                                    <option id="VC_XE_MAY" value="VC_XE_MAY" name="Vật chất xe máy">Vật chất xe máy</option>
                                                                </select>
                                                            </td>
                                                            <td><input type="text" class="form-control input-number text-left" value="500" placeholder="0"></td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <select select2="" class="form-control">
                                                                    <option selected="" value="GCNBH_MV" id="GCNBH_MV">Ấn chỉ bảo hiểm xe ô tô</option>
                                                            ...
                                                            <td>
                                                                <select select2="" class="form-control">
                                                                    <option id="" value="" name="">--- Chọn ---</option>
                                                                    <option id="BAT_BUOC" value="BAT_BUOC" name="Bắt buộc">Bắt buộc</option>
                                                                    <option selected="" id="BAT_BUOC_DAI" value="BAT_BUOC_DAI" name="Bắt buộc dài">Bắt buộc bao gồm tai nạn</option>
                                                                    <option id="BAT_BUOC_TU_NGUYEN" value="BAT_BUOC_TU_NGUYEN" name="Bắt buộc và tự nguyện">Bắt buộc và tự nguyện</option>
                                                                    <option id="VC_XE_MAY" value="VC_XE_MAY" name="Vật chất xe máy">Vật chất xe máy</option>
                                                                </select>
                                                            </td>
                                                            <td><input type="text" class="form-control input-number text-left" value="30" placeholder="0"></td>
                                                            <td><a href="javascript:;" data-repeater-delete="" class="d-flex align-items-center font-weight-bold text-danger"><i class="icon-trash mr-1"></i>Xoá</a></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td><input type="text" class="form-control input-number text-left" value="15" placeholder="0"></td>
                                                            <td><a href="javascript:;" data-repeater-delete="" class="d-flex align-items-center font-weight-bold text-danger"><i class="icon-trash mr-1"></i>Xoá</a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
