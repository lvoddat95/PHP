	...
	<script src="<?php echo ASSET_ROOT; ?>/vendors/js/bootstrap/bootstrap-datepicker.vi.min.js"></script>
	...
	<script src="<?php echo ASSET_ROOT; ?>/js/form_wizard.js"></script>
	<script src="<?php echo ASSET_ROOT; ?>/js/cleave-phone.vn.js"></script>
	<!-- /Custom JS Trang-->
