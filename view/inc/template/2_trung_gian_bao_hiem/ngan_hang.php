<div id="ngan_hang_opt" class="row" style="display: none;">
    ...
    <div class="col-md-3">
        <?php inc('template/2_trung_gian_bao_hiem/can_bo_ngan_hang.php'); ?>
    </div>
    <div class="col-md-3">
        <div class="form-group ">
            <?php inc('template/2_trung_gian_bao_hiem/khoi_khach_hang.php'); ?>
        </div>
    </div>
    <div class="col-md-3">
        <?php inc('template/2_trung_gian_bao_hiem/ngan_hang_thu_huong.php'); ?>
    </div>
</div>