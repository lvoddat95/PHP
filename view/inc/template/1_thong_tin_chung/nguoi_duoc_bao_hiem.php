        ...
        <div class="col-md-8 col-sm-8">
            <div class="input-group">
                ...
                <span class="input-group-append">
                    <button type="button" class="btn bg-primary" data-fancybox data-base-class="fancybox-container-lg" data-type="iframe" data-src="https://gakutenjapan.com/" href="javascript:;">Chọn</button>
                </span>
            </div>
        </div>
    </div>
