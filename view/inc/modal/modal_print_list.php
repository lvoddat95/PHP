            ...
            <form action="#">
                ...
                <div class="modal-body">
                    ...
                    <div class="dropdown-item d-flex align-items-center">
                        <input id="in01" class="mr-1" type="radio" name="in">
                    ...
                    <div class="dropdown-item d-flex align-items-center">
                        <input id="in02" class="mr-1" type="radio" name="in">
                    ...
                    <div class="dropdown-item d-flex align-items-center">
                        <input id="in03" class="mr-1" type="radio" name="in">
                    ...
                    <div class="dropdown-item d-flex align-items-center">
                        <input id="in04" class="mr-1" type="radio" name="in">
                    ...
                    <div class="dropdown-item d-flex align-items-center">
                        <input id="in05" class="mr-1" type="radio" name="in">
                    ...
                    <div class="dropdown-item d-flex align-items-center">
                        <input id="in06" class="mr-1" type="radio" name="in">
                        <label for="in06" class="mb-0" data-tooltip="tipsy" original-title="In giấy chứng nhận Học sinh Sinh viên" data-position="right"><i class="icon-certificate"></i> In GCN HSSV</label>
                        <?php inc('modal/modal_in_gcn_hssv.php'); ?> 
                    </div>
                    <div class="dropdown-divider"></div>
                    <div>
                        <a href="#" class="dropdown-item bg-primary justify-content-center" onclick="fancybox_modal(this,'#in_gcn_hssv');"><i class="icon-printer2"></i>IN</a>
                    </div>
                </div>
            </form>
        </div>
