<!-- Trình duyệt đơn -->
<div id="trinh_duyet_nhieu_don" class="modal fade" tabindex="-1" datatable-modal>
                    ...
                    <table class="table-list table table-bordered table-hover datatable" 
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><span class="badge badge-danger badge-icon-circle"><i class="icon-"></i></span> Số tiền duyệt trên phân cấp</td>
                            </tr>
                            <tr>
