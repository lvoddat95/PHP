            ...
            <div class="sidebar-content">
                ...
                <div class="card card-sidebar-mobile">
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo HTTP_PATH ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo HTTP_PATH ?>" class="nav-link active">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" scrollbar data-submenu-title="Xuất kho">
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Xuất ấn chỉ cho chi nhánh</span></a></li>
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Xuất ấn chỉ cho phòng ban</span></a></li>
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Xuất ấn chỉ cho cán bộ</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" scrollbar data-submenu-title="Đề nghị cấp AC">
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Đề nghị cấp ấn chỉ của chi nhánh</span></a></li>
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Đề nghị cấp ấn chỉ của phòng ban</span></a></li>
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Đề nghị cấp ấn chỉ của bộ</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" scrollbar data-submenu-title="Huỷ / mất AC">
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Khai thác AC Huỷ/Mất <br>(Bộ phận khai thác nhập)</span></a></li>
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Khai thác AC Huỷ/Mất <br>(Kế toán AC nhập)</span></a></li>
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Import AC Xe máy</span></a></li>
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Import AC tai nạn HSD điện</span></a></li>
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Import AC toàn diện hộ GĐ</span></a></li>
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Import AC tai nạn con người</span></a></li>
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Import AC tai nạn giao thông</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" scrollbar data-submenu-title="Nhập trả AC">
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Nhập trả AC trắng <br>(Nguyên quyển)</span></a></li>
                                <li class="nav-item"><a href="" class="nav-link"><span class="menu-title">Nhập huỷ AC</span></a></li>
                            </ul>
                        </li>
