	...
	<table class="table table-bordered bg-white">
	    <thead>
	        <tr class="header">
	            ...
	            <td rowspan="2" width="30%">Tên bộ phận (Thương tật/ Phẫu thuật)</td>
	            <td rowspan="2" width="8%" align="center">Loại hình</td>
	            <td rowspan="2" width="10%" align="center">Nhóm bộ phận</td>
	            <td colspan="2" width="7%" align="center">Ti lệ</td>
	            <td rowspan="2" width="5%" align="center">Tỉ lệ chi trả</td>
	            <td rowspan="2" width="10%" align="center">Tiền phải trả</td>
	        </tr>
	        <tr class="header">
