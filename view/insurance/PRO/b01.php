                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="icon-arrow-left16 mr-1"></i>B01 - Bảo hiểm hỏa hoạn và các rủi ro đặc biêt</a>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <table class="table table-bordered" style="margin: auto;">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>Phạm vi A (Chết do ốm đau, bệnh tật, thai sản)</td>
                                                                                    <td class="text-right">0</td>
                                                                                </tr>
                                                                                
                                                                                <tr>
                                                                                    <td>Phạm vi B (Chết và thương tật thân thể do tai nạn)</td>
                                                                                    <td class="text-right">0</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Phạm vi C (Ốm đau, bệnh tật, thai sản phải nằm viện hoặc phẫu thuật)</td>
                                                                                    <td class="text-right">0</td>
                                                                                </tr>
