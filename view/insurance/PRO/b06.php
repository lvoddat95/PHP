...
<?php $GLOBALS["quy_tac_bao_hiem_b06"] = 'b06'; ?>
                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="fa fa-reply mr-1"></i>B06 - Bảo hiểm tiền</a>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <select class="form-control" select2>
                                                                                                        <option itle="Mức trách nhiệm < 5 tỷ">Mức trách nhiệm &lt; 5 tỷ</option>
                                                                                                        <option title="Mức trách nhiệm từ 5 tỷ đến 100 tỷ">Mức trách nhiệm từ 5 tỷ đến 100 tỷ</option>
                                                                                                        <option title="Mức trách nhiệm từ 100 tỷ trở lên">Mức trách nhiệm từ 100 tỷ trở lên</option>
                                                                                                    </select>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <textarea disabled class="form-control" placeholder="Nhập rủi ro...">Bảo hiểm cho thiệt hại hay tổn thất vật chất bất ngờ đối với tiền được bảo hiểm tại địa điểm được bảo hiểm bị tổn thất, phá hủy hoặc thiệt hại do bất kỳ nguyên nhân nào không bị hợp đồng bảo hiểm loại trừ phát sinh trong thời hạn bảo hiểm.</textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>Điều kiện bảo hiểm: </label>
                                                                                    <textarea class="form-control" placeholder="Nhập điều kiện bảo hiểm..." disabled="">Bảo hiểm mọi rủi ro về tiền</textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
