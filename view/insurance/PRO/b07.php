...
<?php $GLOBALS["quy_tac_bao_hiem_b07"] = 'b07'; ?>
                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="fa fa-reply mr-1"></i>B07 - Bảo hiểm hư hỏng hàng hóa trong kho lạnh</a>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <textarea class="form-control" placeholder="Nhập điều kiện bảo hiểm..." disabled="">Bảo hiểm hư hỏng hàng hóa trong kho lạnh</textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
