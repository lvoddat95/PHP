...
<?php $GLOBALS["quy_tac_bao_hiem_b01"] = 'b16'; ?>
                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="fa fa-reply mr-1"></i>B16 - Bảo hiểm toàn diện nhà chung cư</a>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <select class="form-control" select2>
                                                                                                        <option>1. Hỏa hoạn, sét đánh (A) </option>
                                                                                                    </select>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td>2. Chết và Thương tật thân thể do tai nạn</td>
                                                                                                <td><input class="form-control text-right input-money" type="text" placeholder="0"></td>
                                                                                                <td><input class="form-control text-right input-float" type="text" placeholder="0" value="0.99"></td>
                                                                                                <td><input class="form-control text-right input-money" type="text" placeholder="0"></td>
                                                                                                <td><input class="form-control text-right input-float" type="text" value="10"></td>
                                                                                                ...
                                                                                                <td>
                                                                                                    <select class="form-control" select2>
                                                                                                        <option>2. Chết và Thương tật thân thể do tai nạn</option>
                                                                                                    </select>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
