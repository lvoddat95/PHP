                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="fa fa-reply mr-1"></i> G09 - Bảo hiểm tai nan đối với người lao động</a>
                                                                            ...
                                                                            <table class="table table-sm table-bordered datatable child-row-sm" data-control-right="true" data-paging="false" data-info="false" data-ordering="false" data-searching="false" >
                                                                                <thead class="thead-light">
                                                                                    <tr>
                                                                                        ...
                                                                                        <th colspan="3" class="text-center desktop">Chết/Thương tật vĩnh viễn</th>
