                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="icon-arrow-left16 mr-1"></i> G05 - Bảo hiểm toàn diện học sinh</a>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <select class="form-control " select2 name="dinh_muc" >
                                                                                                    <option>Nhóm học sinh cấp 3 trở lên</option>    
                                                                                                    <option>Nhóm học sinh cấp 2 trở xuống</option>    
                                                                                                </select>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <table class="table table-bordered" style="margin: auto;">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>Phạm vi A (Chết do mọi nguyên nhân)</td>
                                                                                    <td class="text-right">0</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Phạm vi B (Thương tật thân thể do tai nạn)</td>
                                                                                    <td class="text-right">0</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Phạm vi C (Phẫu thuật do ốm đau bệnh tật)</td>
                                                                                    <td class="text-right">0</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Phạm vi D (Nằm viện do ốm đau, bệnh tật, thương tật thân thể do tai nạn)</td>
                                                                                    <td class="text-right">0</td>
                                                                                </tr>
