                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="icon-arrow-left16 mr-1"></i> G08 - Bảo hiểm sức khỏe giáo viên</a>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <table class="table table-bordered" style="margin: auto;">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td>Phạm vi C (Ốm đau bệnh tật, thai sản phụ nằm viện hoặc phẩu thuật)</td>
                                                                                <td class="text-right">0</td>
                                                                            </tr>
