                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="fa fa-reply mr-1"></i>H04 - Bảo hiểm trách nhiệm giải thưởng (Hole in one)</a>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <select class="form-control" select2 >
                                                                                                       <option value="">Bảo hiểm trách nghiệm (năm 2012)</option>
