                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="fa fa-reply mr-1"></i>H09 - Bảo hiểm trách nhiệm nghề nghiệp tư vấn trong đầu tư xây dựng (bắt buộc)</a>
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <table class="table table-bordered datatable" 
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td>Trách nhiệm nghề nghiệp tư vấn trong đầu tư xây dựng (bắt buộc)</td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>Trách nhiệm nghề nghiệp tư vấn trong đầu tư xây dựng (tự nguyện)</td>
                                                                                                <td><input class="form-control text-right input-money" type="text" placeholder="0"></td>
                                                                                                <td><input class="form-control text-right input-float" type="text" placeholder="0" value="0.99"></td>
                                                                                                <td><input class="form-control text-right input-money" type="text" placeholder="0"></td>
                                                                                                <td><input class="form-control text-right input-float" type="text" value="10"></td>
