                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="fa fa-reply mr-1"></i>H06 - Bảo hiểm trách nhiệm Giám đốc và Người điều hành</a>
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <table class="table table-bordered datatable" 
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td>Trách nhiệm Giám đốc và Người điều hành</td>
