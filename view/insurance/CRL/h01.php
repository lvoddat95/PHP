                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="fa fa-reply mr-1"></i>H01 - Bảo hiểm trách nhiệm nghề nghiệp</a>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <select class="form-control" select2 >
                                                                                                       <option value="">Mức trách nhiệm < 20 tỷ</option>
                                                                                                       <option value="">Mức trách nhiệm từ 20 tỷ đến 30 tỷ</option>
                                                                                                       <option value="">Mức trách nhiệm từ 30 tỷ trở lên</option>
                                                                                                    </select>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="d-flex align-items-center">
                                                                                        <textarea class="form-control" placeholder="Nhập rủi ro..." disabled>Bảo hiểm trách nhiệm nghề nghiệp</textarea>
