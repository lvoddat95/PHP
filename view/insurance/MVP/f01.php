...
<head>
    ...
    <!-- core stylesheet -->
    <link rel="stylesheet" type="text/css" href="../app-assets/fonts/linearicons/linearicons.css">
    <link rel="stylesheet" type="text/css" href="../app-assets/fonts/iconmoon/iconmoon.min.css">
    <link rel="stylesheet" type="text/css" href="../app-assets/vendors/css/perfect-scrollbar.min.css">
    <link rel="stylesheet" type="text/css" href="../app-assets/vendors/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="../app-assets/css/bootstrap_custom.css">
    ...
    <!-- custom stylesheet -->
    <link rel="stylesheet" type="text/css" href="../app-assets/css/wizard_steps.css">
...
<body class="sidebar-xs">
            ...
            <div class="sidebar-content">
                ...
                <div class="card card-sidebar-mobile">
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        <li class="nav-item">
                            <a href="index.html" class="nav-link active" data-menu-title="Bảng điều khiển">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Bảo hiểm hàng hóa">
                                <li><a href="../e01.html" class="nav-link">E01 - Bảo hiểm hàng hoá xuất nhập khẩu</a></li>
                                <li><a href="../e02.html" class="nav-link">E02 - Bảo hiểm hàng hoá vận chuyển nội địa</a></li>
                                <li><a href="../e06.html" class="nav-link">E06 - Bảo hiểm trách nhiệm giao nhận tổng hợp</a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="javascript:;" class="nav-link">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Bảo hiểm trách nhiệm">
                                <li><a href="../h01.html" class="nav-link"><div class="menu-title">H01 - Bảo hiểm trách nhiệm nghề nghiệp</div></a></li>
                                <li><a href="../h02.html" class="nav-link"><div class="menu-title">H02 - Bảo hiểm trách nhiệm sản phẩm</div></a></li>
                                <li><a href="../h03.html" class="nav-link"><div class="menu-title">H03 - Bảo hiểm trách nhiệm công cộng</div></a></li>
                                <li><a href="../h04.html" class="nav-link"><div class="menu-title">H04 - Bảo hiểm trách nhiệm giải thưởng (Hole in one)</div></a></li>
                                <li><a href="../h06.html" class="nav-link"><div class="menu-title">H06 - Bảo hiểm Trách nhiệm Giám đốc và Người điều hành</div></a></li>
                                <li><a href="../h07.html" class="nav-link"><div class="menu-title">H07 - Bảo hiểm toàn diện ngân hàng</div></a></li>
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Bảo hiểm xe tài sản">
                                <li><a href="../b01.html" class="nav-link">B01 - Bảo hiểm hỏa hoạn và các rủi ro đặc biệt</a></li>
                                <li><a href="../b02.html" class="nav-link">B02 - Bảo hiểm mọi rủi ro tài sản</a></li>
                                <li><a href="../b03.html" class="nav-link">B03 - Bảo hiểm công trình kỹ thuật dân dụng hoàn thành</a></li>            
                                <li><a href="../b04.html" class="nav-link">B04 - Bảo hiểm mọi rủi ro văn phòng</a></li>
                                <li><a href="../b05.html" class="nav-link">B05 - Bảo hiểm mọi rủi ro nhà ở</a></li>
                                <li><a href="../b06.html" class="nav-link">B06 - Bảo hiểm tiền</a></li>
                                <li><a href="../b07.html" class="nav-link">B07 - Bảo hiểm hư hỏng hàng hóa trong kho lạnh</a></li>
                                <li><a href="../b08.html" class="nav-link">B08 - Bảo hiểm lòng trung thành</a></li>
                                <li><a href="../b09.html" class="nav-link">B09 - Chứng thư bảo lãnh</a></li>
                                <li><a href="../b12.html" class="nav-link">B12 - Bảo hiểm bảng hiệu đèn quảng cáo</a></li>
                                <li><a href="../b16.html" class="nav-link">B16 - Bảo hiểm toàn diện nhà chung cư</a></li>
                                <li><a href="../b17.html" class="nav-link">B17 - Bảo hiểm vườn cây cao su</a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="javascript:;" class="nav-link">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Bảo hiểm tàu thuyền">
                                <li><a href="../d01.html" class="nav-link"><div class="menu-title">D01 - Bảo hiểm tàu biển</div></a></li>
                                <li><a href="../d02.html" class="nav-link"><div class="menu-title">D02 - Bảo hiểm tàu sông, tàu ven biển</div></a></li>
                                <li><a href="../d03.html" class="nav-link"><div class="menu-title">D03 - Bảo hiểm tàu cá</div></a></li>
                                <li><a href="../d04.html" class="nav-link"><div class="menu-title">D04 - Bảo hiểm du thuyền</div></a></li>
                                <li><a href="../d05.html" class="nav-link"><div class="menu-title">D05 - Bảo hiểm rủi ro đóng tàu</div></a></li>
                                <li><a href="../d06.html" class="nav-link"><div class="menu-title">D06 - Bảo hiểm trách nhiệm người sửa chữa tàu</div></a></li>
                                <li><a href="../d07.html" class="nav-link"><div class="menu-title">D07 - Bảo hiểm trách nhiệm dân sự chủ tầu viễn dương (P&amp;I mutual)</div></a></li>
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Bảo hiểm kĩ thuật">
                                <li><a href="../c01.html" class="nav-link"><div class="menu-title">C01 - Bảo hiểm mọi rủi ro trong xây dựng</div></a></li>
                                <li><a href="../c02.html" class="nav-link"><div class="menu-title">C02 - Bảo hiểm mọi rủi ro trong lắp đặt</div></a></li>
                                <li><a href="../c03.html" class="nav-link"><div class="menu-title">C03 - Bảo hiểm máy móc thiết bị của chủ thầu</div></a></li>
                                <li><a href="../c04.html" class="nav-link"><div class="menu-title">C04 - Bảo hiểm đổ vỡ máy móc</div></a></li>
                                <li><a href="../c05.html" class="nav-link"><div class="menu-title">C05 - Bảo hiểm mất lợi nhuận do đổ vỡ máy móc</div></a></li>
                                <li><a href="../c06.html" class="nav-link"><div class="menu-title">C06 - Bảo hiểm thiết bị điện tử</div></a></li>
                                <li><a href="../c07.html" class="nav-link"><div class="menu-title">C07 - Bảo hiểm mọi rủi ro máy móc thiết bị cho thuê</div></a></li>
                                <li><a href="../c08.html" class="nav-link"><div class="menu-title">C08 - Bảo hiểm nồi hơi</div></a></li>
                                <li><a href="../c09.html" class="nav-link"><div class="menu-title">C09 - Bảo hiểm toàn diện đối với máy móc thiết bị</div></a></li>
                                <li><a href="../c10.html" class="nav-link"><div class="menu-title">C10 - Bảo hiểm mọi rủi ro trong công nghiệp</div></a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="javascript:;" class="nav-link">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Bảo hiểm hàng không">
                                ...
                                <li><a href="../a02.html" class="nav-link"><div class="menu-title"> A02 - Bảo hiểm thân máy bay dưới mức miễn thường </div></a></li>
                                <li><a href="../a03.html" class="nav-link"><div class="menu-title">A03 - Bảo hiểm thân, phụ tùng máy bay đối với rủi ro chiến tranh</div></a></li>
                                <li><a href="../a04.html" class="nav-link"><div class="menu-title">A04 - Bảo hiểm trách nhiệm đối với rủi ro chiến tranh</div></a></li>
                                <li><a href="../a05.html" class="nav-link"><div class="menu-title">A05 - Bảo hiểm mất khả năng sử dụng máy bay</div></a></li>
                                <li><a href="../a06.html" class="nav-link"><div class="menu-title">A06 - Bảo hiểm tai nạn nhân viên tổ bay</div></a></li>
                                <li><a href="../a07.html" class="nav-link"><div class="menu-title">A07 - Phí Cty BH gốc</div></a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="javascript:;" class="nav-link">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Nhận tái cố định">
                                <li><a href="../j01.html" class="nav-link"><div class="menu-title">J01 - Nhận tái cố định nhóm bảo hiểm hàng hóa</div></a></li>
                                <li><a href="../j04.html" class="nav-link"><div class="menu-title">J04 - Nhận tái cố định nhóm bảo hiểm hàng không</div></a></li>
                                <li><a href="../j05.html" class="nav-link"><div class="menu-title">J05 - Nhận tái cố định nhóm bảo hiểm tài sản</div></a></li>
                                <li><a href="../j06.html" class="nav-link"><div class="menu-title">J06 - Nhận tái cố định nhóm bảo hiểm kỹ thuật</div></a></li>
                                <li><a href="../j07.html" class="nav-link"><div class="menu-title">J07 - Nhận tái cố định nhóm bảo hiểm tàu thuyền</div></a></li>
                                <li><a href="../j08.html" class="nav-link"><div class="menu-title">J08 - Nhận tái cố định nhóm bảo hiểm xe cơ giới</div></a></li>
                                <li><a href="../j09.html" class="nav-link"><div class="menu-title">J09 - Nhận tái cố định nhóm bảo hiểm con người</div></a></li>
                                <li><a href="../j10.html" class="nav-link"><div class="menu-title">J10 - Nhận tái cố định nhóm bảo hiểm trách nhiệm</div></a></li>
                                <li><a href="../j11.html" class="nav-link"><div class="menu-title">J11 - Nhận tái cố định nhóm bảo hiểm dầu khí</div></a></li>
                            </ul>
                        </li>
            ...
            <div class="content">
                ...
                <div class="mobile-bottom" >
                    <a class="item" href="index.html">
                        <i class="icon linearicons-home"></i>
                        <span>Trang chủ</span>
                    </a>
                    <a class="item mess" href="index.html">
                        <i class="icon linearicons-bubble-dots"><span class="badge ">9</span></i>
                        <span>Thông báo</span>
                    </a>
                    <a class="item" href="index.html">
                        <i class="icon linearicons-layers"></i>
                        <span>Ứng dụng</span>
                    </a>
                    <a class="item sidebar-mobile-main-toggle" href="javascript:;">
                        <i class="icon linearicons-text-align-left"></i>
                        <span>Menu</span>
                    </a>
                </div>
                    ...
                    <div class="top-right">
                        <ul class="list-unstyled d-flex align-items-center">
                            <li class="header-search">
                                ...
                                <a href="#" class="btn-search"><i class="linearicons-magnifier"></i></a>
                            </li>
                            <li>
                                        ...
                                        <ul class="media-list dropdown-scrollable">
                                            <li class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="media-title">
                                                        <a href="#">
                                                            <span class="font-weight-semibold">Thông báo mất ấn chỉ xe máy</span>
                                                            <span class="text-muted float-right font-size-xxs">22/04</span>
                                                        </a>
                                                    </div>
                
                                                    <span class="text-muted font-size-xxs">VNI HCM gửi chứng từ báo mất ấn chỉ tháng 04/2020 </span>
                                                </div>
                                            </li>
                                            ...
                                            <li class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="media-title">
                                                        <a href="#">
                                                            <span class="font-weight-semibold">Danh bạ điện thoại VNI 04/2020</span>
                                                            <span class="text-muted float-right font-size-xxs">19/04</span>
                                                        </a>
                                                    </div>
                
                                                    <span class="text-muted font-size-xxs">Danh bạ điện thoại toàn hệ thống VNI tính đến ngày
                                                        19/4/2020</span>
                                                </div>
                                            </li>
                                            ...
                                            <li class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="media-title">
                                                        <a href="#">
                                                            <span class="font-weight-semibold">Chương trình thi đua “Cùng tăng tốc –
                                                                Vượt mốc doanh thu”</span>
                                                            <span class="text-muted float-right font-size-xxs">18/04</span>
                                                        </a>
                                                    </div>
                
                                                    <span class="text-muted font-size-xxs">BH bắt buộc TNDS xe máy &amp; bảo hiểm tai nạn con người
                                                        theo ...</span>
                                                </div>
                                            </li>
                                            ...
                                            <li class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="media-title">
                                                        <a href="#">
                                                            <span class="font-weight-semibold">Cấp phát mũ bảo hiểm cho CBNV trên toàn
                                                                hệ thống</span>
                                                            <span class="text-muted float-right font-size-xxs">18/04</span>
                                                        </a>
                                                    </div>
                
                                                    <span class="text-muted font-size-xxs">Nhằm quảng bá thương hiệu, hình ảnh VNI một các đồng bộ,
                                                        Tổng công ty...</span>
                                                </div>
                                            </li>
                                            ...
                                            <li class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="media-title">
                                                        <a href="#">
                                                            <span class="font-weight-semibold">Chỉnh sửa mã đại lí trên đơn bảo
                                                                hiểm</span>
                                                            <span class="text-muted float-right font-size-xxs">15/04</span>
                                                        </a>
                                                    </div>
                
                                                    <span class="text-muted font-size-xxs">Đơn bảo hiểm bảo hiểm 032002397/F02 phát sinh
                                                        ngày...</span>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="dropdown-content-footer bg-light">
                                        ...
                                        <div>
                                            <a href="#" class="text-grey" data-popup="tooltip" title=""
                                                data-original-title="Đánh dấu đã đọc"><i class="icon-radio-unchecked"></i></a>
                                            <a href="#" class="text-grey ml-2" data-popup="tooltip" title=""
                                                data-original-title="Cài đặt"><i class="icon-cog3"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                                ...
                                                <form action="#" class="steps-validation wizard-notification">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id='test' type="text" name="ngay_cap" class="form-control input-date" placeholder="dd/mm/yyyy">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <fieldset>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group ">
                                                                    ...
                                                                    <select class="form-control required" select2 name="nhom_xe">
                                                                        ...
                                                                        <option>Mô tô 2 bánh - Từ 50 cc trở xuống</option>
                                                                        <option>Mô tô 2 bánh - Trên 50 cc</option>
                                                                        <option>Mô tô ba bánh, xe gắn máy và các loại xe cơ giới tương tự</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group ">
                                                                    ...
                                                                    <input type="text" class="form-control" name="nhan_hieu" placeholder="Nhập nhãn hiệu..." value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label>Năm sản xuất: <span class="text-danger">*</span></label>
                                                                    <input type="text" class="form-control" name="nam_sx" placeholder="Nhập sản xuất..." value="">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group ">
                                                                    <label>Số GCN xe: </label>
                                                                    <input type="text" class="form-control" name="so_gcn" placeholder="Nhập số GCN xe..." value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group ">
                                                                    <label>Dung tích:</label>
                                                                    <input type="text" class="form-control" name="dung_tich" placeholder="Nhập dung tích..." value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group ">
                                                                    <label>Màu sơn:</label>
                                                                    <input type="text" class="form-control" name="mau_son" placeholder="Nhập màu sơn..." value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group ">
                                                                    <label>Số khung:</label>
                                                                    <input type="text" class="form-control" name="so_khung" placeholder="Nhập số khung..." value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group ">
                                                                    <label>Số máy:</label>
                                                                    <input type="text" class="form-control input-money" name="so_may" placeholder="Nhập số máy..." value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group ">
                ...
                <!-- Footer -->
                <div id="footer" class="d-flex align-items-center justify-content-between pt-3 pb-1">
                    <span> Bản quyền © 2020. <a href="#">Tổng công ty Cổ phần Bảo hiểm Hàng không</a> </span>
                    <span>
                        <a class="d-flex align-items-center text-pink-400" href="https://www.bhhk.com.vn" target="_blank" ><i class="linearicons-network mr-1"></i> www.bhhk.com.vn</a>
                    </span>
                </div>
                <!-- /Footer -->
            </div>
    ...
    <div class="chat-box">
        <div class="chat">
            <div class="chat-header">
                <div class="cb-pic">
                    <img class="img-fluid" src="../app-assets/images/icon-user.png" alt="avatar">
                </div>
                <div class="cb-name">
    ...
    <div class="quick-action">
        <a href="javascript:;" class="btn-act btn-act-toggle open" data-tooltip="tipsy" original-title="Mở ra" data-position="left"><i class="icon-move-left"></i></a>
        <ul class="list-unstyled mb-0">
            ...
            <li><a href="../javascript:;" class="btn-act" data-tooltip="tipsy" original-title="Trình duyệt đơn" data-position="left"><i class="icon-file-check2"></i></a></li>
            <li><a href="../javascript:;" class="btn-act" data-tooltip="tipsy" original-title="Đóng đơn" data-position="left"><i class="icon-file-locked2"></i></a></li>
    ...
    <script src="../app-assets/vendors/js/jquery_ui/blockui.min.js"></script>
    ...
    <script src="../app-assets/vendors/js/form/jquery.steps.min.js"></script>
    <script src="../app-assets/vendors/js/form/jquery.validate.min.js"></script>
    <script src="../app-assets/vendors/js/bootstrap/bootstrap-datepicker.js"></script>
    <script src="../app-assets/vendors/js/bootstrap/bootstrap-datepicker.vi.min.js"></script>
    ...
    <script src="../app-assets/js/form_wizard.js"></script>
    <script src="../app-assets/js/cleave-phone.vn.js"></script>
    <!-- /Custom JS Trang-->
