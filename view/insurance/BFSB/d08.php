                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="fa fa-reply mr-1"></i>D08 - Bảo hiểm bắt cóc và đòi tiền chuộc</a>
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <table class="table table-bordered datatable" 
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td>Bảo hiểm bắt cóc và đòi tiều chuộc</td>
                                                                                                ...
                                                                                                <td>
                                                                                                    <select class="form-control" select2 >
                                                                                                        <option>Bảo hiểm bắt cóc và đòi tiều chuộc</option>
                                                                                                    </select>
                                                                                                </td>
                                                                                            </tr>
