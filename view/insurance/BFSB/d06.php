                                                                ...
                                                                <div class="tab-content">
                                                                    ...
                                                                    <fieldset class="tab-pane" id="step3">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-3">
                                                                                <div class="form-group">
                                                                                    <label for="">Giá trị tàu sửa chữa:</label>
                                                                                    <input type="text" class="form-control input-money text-right" placeholder="0">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                <div class="form-group">
                                                                                    <label for="">Mức trách nhiệm của người sửa chữa:</label>
                                                                                    <input type="text" class="form-control input-money text-right" placeholder="0">
                                                                                </div>
                                                                            </div>
                                                                        </div>
