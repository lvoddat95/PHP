                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="fa fa-reply mr-1"></i>C06 - Bảo hiểm thiết bị điện tử</a>
                                                                                    ...
                                                                                    <div class="p-body collapse show">
                                                                                        ...
                                                                                        <div class="c-item">
                                                                                            <div class="c-title">
                                                                                                ...
                                                                                                <a data-toggle="collapse" class="collapsed" href="#collapsible-item1">Thiết bị điện tử</a>
                                                                                            </div>
