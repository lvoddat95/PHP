                    ...
                    <div class="header-top">
                        ...
                        <div class="top-left">
                            <div class="breadcrumb">
                                <a href="<?php echo HTTP_PATH .'view/pages/danh-sach-don.php'; ?>" class="breadcrumb-item"><i class="fa fa-reply mr-1"></i>C05 - Bảo hiểm mất lợi nhuận do đổ vỡ máy móc</a>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <select class="form-control" select2 >
                                                                                                        <option>Giá trị bảo hiểm < 150 tỷ</option>
                                                                                                        <option>Giá trị bảo hiểm từ 150 tỷ đến 900 tỷ</option>
                                                                                                        <option>Giá trị bảo hiểm từ 900 trở lên</option>
                                                                                                    </select>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
