...
<?php include_once HEADER; ?>
    ...
    <body class="sidebar-xs">
                                ...
                                <div class="card">
                                    <div class="card-header card-header-sticky">
                                        <div class="page-title">
                                            <div class="p-title">
                                                <p class="font-weight-semibold font-size-m mb-0"><i class="icon-certificate mr-2"></i>Đơn bảo hiểm: F02.123456789</p>
                                            </div>
                                            <div class=" p-button">
                                                        ...
                                                        <section>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <form action="#" class="">
                                                                        <!-- Bước 1 -->
                                                                        <div class="card border-1 border-dashed border-silver card-collapsed">
                                                                        ...
                                                                        <!-- Bước 4 -->
                                                                        <div class="card border-1 border-dashed border-silver ">
                                                                            <div class="card-header header-elements-inline" data-action="collapse">
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="card-block">
                                                                                    <fieldset>
                                                                                        ...
                                                                                        <?php inc('template/4_pham_vi_bao_hiem/dinh_muc_khac.php'); ?>
        ...
        <?php inc('modal/modal_them_dinh_muc.php'); ?> 
        <?php inc('modal/modal_bo_sung_dinh_muc.php'); ?> 
